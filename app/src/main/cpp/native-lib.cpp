...
Java_cn_isif_cpc_core_jni_ImageUtilEngine_decodeYUV420SP(JNIEnv *env, jobject thiz, jbyteArray buf,
                                                         jint width, jint height) {
    jbyte * yuv420sp = (*env).GetByteArrayElements( buf, JNI_FALSE);
